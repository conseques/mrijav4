                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        {activeTab === 'tasks' && (
                            <section style={{ backgroundColor: 'var(--container-bg)', padding: '24px', borderRadius: '16px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
                                ...
                                <p style={{ color: 'var(--text-muted)' }}>Tasks matching your skills will appear here.</p>
                            </section>
                        )}
                            ...
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                                {profile?.skills && profile.skills.length > 0 ? (
                                    profile.skills.map((skill, index) => (
                                        <span key={index} style={{ padding: '4px 8px', backgroundColor: 'var(--badge-bg)', border: '1px solid var(--badge-border)', borderRadius: '6px', fontSize: '12px', color: 'var(--text-color)' }}>
                                            {skill}
                                        </span>
                                    ))
                                ) : (
